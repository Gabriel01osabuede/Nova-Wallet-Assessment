...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NovaWallet.Api.Domain.LedgerRecords.AuditEntry", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("NovaWallet.Api.Domain.LedgerRecords.IdempotencyRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NovaWallet.Api.Domain.LedgerRecords.Transfer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NovaWallet.Api.Domain.LedgerRecords.WalletTransaction", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("NovaWallet.Api.Domain.LedgerRecords.WalletTransaction", b =>
                {
                    b.HasOne("NovaWallet.Api.Domain.LedgerRecords.Transfer", null)
                        .WithMany()
